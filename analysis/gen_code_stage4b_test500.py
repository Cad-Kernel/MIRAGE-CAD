...
predicted_rows = read_jsonl(Path('outputs/lora_ir_5k/predicted_ir_test500_full.jsonl'))

out_path = Path('outputs/qwen25_coder_1_5b_program_5k_stage4b/gen_test500_from_predicted_ir.jsonl')
